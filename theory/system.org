...
:CREATED:  <2026-03-31 Tue 22:39>
:END:
- [[https://en.wikipedia.org/wiki/Multitier_architecture][Multitier architecture - Wikipedia]]
- [[https://tchayen.com/how-to-write-a-flexbox-layout-engine][How to Write a Flexbox Layout Engine]]
** DDD
:PROPERTIES:
:ID:       1d6dfd1b-692c-4253-a364-e0e63b2cb048
:CREATED:  <2026-03-31 Tue 22:40>
:END:
:EDGES:
[2026-03-31 Tue 22:41] -- [[wikipedia:Domain-driven design][wiki]]
:END:
Domain-driven design
- focuse on modeling software to match a domain according to input
  from domain experts.
- against the idea of a single unified model
  - divides large system into bounded contexts, each with their own model
** TDD
:PROPERTIES:
:ID:       5773b3bd-37cd-406e-87ad-a041389f4198
:CREATED:  <2026-03-31 Tue 22:50>
:END:
:EDGES:
[2026-03-31 Tue 22:51] -- [[wikipedia:Test-driven development][wiki]]
:END:
...
:CREATED:  <2026-03-07 Sat 18:28>
:AKA: Lipsum
:END:
:EDGES:
[2026-03-07 Sat 18:28] -- [[https://www.lipsum.com/][Lorem Ipsum - All the facts - Lipsum generator]]
:END:
** Web                                                                  :web:
:PROPERTIES:
