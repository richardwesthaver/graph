...
* FS                                                                     :fs:
:PROPERTIES:
:ID:       8ff74861-a0bc-49e1-83eb-3a32f8f8fb78
:CREATED:  <2025-02-15 Sat 16:31>
:AKA: File System
:END:
:EDGES:
[2025-10-11 Sat 21:59] -- [[man:file-hierarchy][man]]
:END:
#+cite_export: csl
#+print_bibliography:
** BTRFS                                                              :btrfs:
...
** ZFS                                                                  :zfs:
:PROPERTIES:
:ID:       3c828873-641e-4846-abd6-781605f33f60
:CREATED:  <2025-02-15 Sat 16:32>
:END:
-- [cite/t/f:@zfs]
- core component of TrueNAS software
** XFS
:PROPERTIES:
:ID:       a5dab699-aa5f-4862-a733-90e62efbeaf4
:CREATED:  <2025-10-11 Sat 21:59>
:END:
:EDGES:
[2025-10-11 Sat 22:00] -- [[wikipedia:XFS][wiki]]
[2025-10-11 Sat 22:00] -- [[https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/7/html/storage_administration_guide/ch-xfs][red hat docs]]
[2025-10-11 Sat 22:00] -- [[https://linuxvox.com/blog/linux-xfs/#google_vignette][Unveiling the Power of Linux XFS]]
:END:
XFS is a high-performance 64-bit journaling file system created by
Silicon Graphics, Inc (SGI) in 1993.
** ext4
:PROPERTIES:
:ID:       a879d61f-2ac0-4755-8e1b-c80b2477bbd6
:CREATED:  <2025-10-11 Sat 22:01>
:END:
:EDGES:
[2025-10-11 Sat 22:01] -- [[wikipedia:Ext4][wiki]]
:END:
ext4 (fourth extended filesystem) is a journaling file system for
Linux, developed as the successor to ext3.
** bcachefs
:PROPERTIES:
:ID:       55db3738-f09f-46d6-99e3-be4232cc14ad
:CREATED:  <2025-10-11 Sat 22:02>
:END:
:EDGES:
[2025-10-11 Sat 22:02] -- [[https://bcachefs.org/][bcachefs]]
[2025-10-11 Sat 22:03] -- [[archwiki:bcachefs][archwiki]]
:END:
Another COW, more robust and fresher impl than BTRFS
- [[https://linuxiac.com/torvalds-drops-bcachefs-from-linux-6-17-amid-maintainer-dispute/][Torvalds Drops Bcachefs from Linux 6.17 Amid Maintainer Dispute]]
** NFS
:PROPERTIES:
:ID:       9f0abbb7-4636-492b-ae4d-ef09cc1f6ef0
:CREATED:  <2026-04-19 Sun 20:50>
:AKA: Network File System
:END:
:EDGES:
[2026-04-19 Sun 20:51] -- [[https://wiki.archlinux.org/title/NFS][NFS - ArchWiki]]
[2026-04-19 Sun 20:56] -- [[https://nfs.sourceforge.net/][Linux NFS faq]]
[2026-04-19 Sun 21:22] -- [[https://www.rfc-editor.org/rfc/rfc7530][RFC 7530]]
[2026-04-19 Sun 21:22] -- [[https://www.rfc-editor.org/rfc/rfc7531][RFC 7531]]
:END:
#+begin_quote
Q. Which local file systems can I export with the Linux NFS server?

A. We expect the following local file systems to work, as they are
tested often: ext2, ext3, jfs, reiserfs, xfs.

These local file systems may work or may have a few minor-ish issues:
iso9660, ntfs, reiser4, udf. Ask on the NFS mailing list for details.

Any file system based on FAT or not having the ability to provide
permanent inode numbers will have trouble with NFS versions 2 and 3
(see question C4).

Local file systems that are known not to work with the Linux NFS
server are: procfs, sysfs, tmpfs (and friends).
#+end_quote

- for the most part our preference is [[id:a5dab699-aa5f-4862-a733-90e62efbeaf4][XFS]].
- has a netlink interface: ~/usr/include/linux/nfsd_netlink.h~
- NFSv4 is the most current
- [[https://aur.archlinux.org/packages/ktls-utils][AUR (en) - ktls-utils]] - for TLS encryption options
* File Syncing
:PROPERTIES:
:ID:       5dcc3d7a-8d3e-4efd-9159-45d9d528429b
:CREATED:  <2026-05-18 Mon 20:52>
:END:
Syncing files across devices on a network can be a real pain - the
current best-method we have for easing the pain is ~rsync~.
** rsync
:PROPERTIES:
:ID:       e16f0072-f857-450c-acfc-f4d3b9d1f852
:CREATED:  <2026-05-18 Mon 20:53>
:END:
:EDGES:
[2026-05-18 Mon 20:53] -- [[man:rsync][man]]
:END:
- see also [[https://lsyncd.github.io/lsyncd/][Lsyncd - Live Syncing (Mirror) Daemon]] for ideas..
