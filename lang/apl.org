...
** Output Formatting
:PROPERTIES:
:ID:       a77f962d-087e-4e94-97a1-570da3e02f7f
:CREATED:  <2025-07-31 Thu 20:55>
:END:
#+begin_example
]OUTPUT.Box                                                                                     
...
** Leading Axis Theory
:PROPERTIES:
:ID:       30de3f47-d339-4190-ab43-793a6948e8e0
:CREATED:  <2025-07-31 Thu 21:53>
:END:
:EDGES:
[2025-07-31 Thu 21:53] -- [[https://aplwiki.com/wiki/Leading_axis_theory][Leading axis theory - APL Wiki]]
:END:
- [[https://aplwiki.com/wiki/Major_cell][Major cell - APL Wiki]]
#+begin_quote
In the APL array model and leading axis theory, a major cell, or item,
is a cell of an array which has rank one smaller than the rank of the
array, or equal to it if the array is a scalar. The number of major
cells in an array is its Tally, and a function can be called on the
major cells of an array individually by applying it with rank ¯1 using
the Rank operator. Functions designed to follow leading axis theory
often manipulate the major cells of an array. For example, Reverse
First (⊖) is considered the primary form of Reverse in leading-axis
languages because it can be interpreted as reversing the major cells
of its argument; J removes last-axis Reverse entirely.
#+end_quote
- [[https://aplwiki.com/wiki/Bracket_indexing][Bracket indexing - APL Wiki]]

- squad indexing :: usage of the index function denoted by the squad char
  - [[https://aplwiki.com/wiki/Index_(function)][Index (function) - APL Wiki]]
...
** Nested Array Model
:PROPERTIES:
:ID:       b6c9e124-2b17-4a1f-9195-4859bad6c351
:CREATED:  <2025-07-31 Thu 21:55>
:END:
:EDGES:
[2025-07-31 Thu 21:55] -- [[https://aplwiki.com/wiki/Nested_array_model][Nested array model - APL Wiki]]
:END:
#+begin_quote
The nested array model, or nested array theory, is an array model in
which every element of an array is an array. It is characterized by
the "floating" rule that a scalar array containing a simple scalar
(such as a number or character) is identical to that simple
scalar. Introduced in the 1980s by several dialects including NARS,
Dyalog APL, and APL2, the nested model has become dominant among APLs
designed and used today. However, its use in non-APL languages is
limited, with Nial remaining the primary example. Because of their
shared history, nested APLs also differ from the flat languages SHARP
APL, A+, and J in ways unrelated to the array model; within the nested
languages there is also a soft division between those more like NARS
(including Dyalog) and those more like APL2.
#+end_quote

** Based Array Theory
:PROPERTIES:
:ID:       63b19336-6ff6-4b49-9f9f-a0c7659b0950
:CREATED:  <2025-07-31 Thu 22:58>
:END:
:EDGES:
[2025-07-31 Thu 22:59] -- [[https://mlochbaum.github.io/BQN/doc/based.html][BQN: Based array theory]]
:END:
- [[https://dl.acm.org/doi/abs/10.1145/586656.586663][A based system for general arrays (1981)]]
** Scalar Extension
:PROPERTIES:
:ID:       02d2fec7-4f1a-4881-8401-72510ef8c83b
:CREATED:  <2025-07-31 Thu 22:02>
:END:
:EDGES:
[2025-07-31 Thu 22:02] -- [[https://aplwiki.com/wiki/Scalar_extension][Scalar extension - APL Wiki]]
:END:
...
- example of BQN characters  
  ...
  π‿∞‿@↩←⇐→,⋄  𝕨𝕩𝔽𝔾𝕎𝕏𝕗𝕘𝕊𝕤ℝ𝕣⦃⦄⟨⟩
  #+end_src
  See [[gh:mlochbaum/BQN/blob/master/src/glyphs.bqn][glyphs.bqn]]
